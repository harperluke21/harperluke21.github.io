(function (window) {
    ...
    platform.init = function (game) {
        ...
        // example:
        platform.create(340, 570,0.6,0.5);
        platform.create(500, 240,1,0.5);
        platform.create(60,460,0.5,0.5);
        platform.create(600,460,1,6.5);
        platform.create(340,350,0.5,0.5);
        platform.create(60,240,1,0.5);
